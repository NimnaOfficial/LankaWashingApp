...
public class DryingForm extends JPanel {
    ...
    public DryingForm() {
        ...
        gbc.gridx=0; gbc.gridy=1; add(new JLabel("Fuel Resource:"), gbc);
        gbc.gridx=1; add(cmbFuel, gbc);

        gbc.gridx=0; gbc.gridy=2; add(new JLabel("Usage (Kg):"), gbc);
        gbc.gridx=1; add(txtWood, gbc);

        gbc.gridx=0; gbc.gridy=3; add(new JLabel("Method:"), gbc);
